    ...
    public void init() {
        ...
        if (!SHORT) {
            ...
            leftStart = (b) -> b
                    ...
                    .waitSeconds(0.5)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> stateManager.raiseExtendo())
                    .setReversed(false)
        ...
        Function<TrajectorySequenceBuilder, TrajectorySequenceBuilder> cycle = (b) -> b
                ...
                .splineTo(flipVector(new Vector2d(-55, -12)), flipDirection(Math.toRadians(180)))
                ...
                .waitSeconds(1)
                .splineTo(flipVector(new Vector2d(-57.5, -12)), flipDirection(Math.toRadians(180)))
                .waitSeconds(1)
                .setReversed(false)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> stateManager.queueState(StateManager.State.LOWERED))
                .splineTo(flipVector(new Vector2d(25, -12)), flipDirection(Math.toRadians(0)));
                // .UNSTABLE_addTemporalMarkerOffset(1, () -> stateManager.queueState(StateManager.State.LOWERED));
